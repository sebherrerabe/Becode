...
console.log(
  "Choose 2 numbers and decide if you want to add or substract them"
);
...
rl.question("Enter the first number : ", function (nb1) {
    ...
    nb2 = parseInt(nb2)
    console.log(nb2)
    rl.question("Addition or Substraction? : Answers: 1. 'Sum' - 2. 'Subs' :    ", function (mathAnswer) {
    total = 0;
    
    if (mathAnswer == "sum") {
        total = nb1 + nb2;
        console.log(`The result of this sum is ${total}`)
    } else if (mathAnswer === "subs") {
        total = nb1 - nb2;
        console.log(`The result of this substraction is ${total}`)
    } else {
